        ...
        <form>
          <ul className={styles.one}>
            <li className={styles.left}>
              ...
              <input type="file" placeholder="profile" accept="image/*" onChange={handleImageChange} required/>
            </li>
            <li className={styles.right}>
              <ul>
              <li className={styles.name}>
                <input type="text" id={styles.name} name="name" placeholder={User_details.name} 
                value={newdetails.name} onChange={handleChange} required/>
              </li>
              <li className={styles.title}>
                <select name="title" id={styles.title} value={newdetails.title} onChange={handleChange} required>
              ...
              <li className={styles.position}>
                <select name="position" id={styles.position} value={newdetails.position} onChange={handleChange} required>
              ...
              <li>
                <select name="province" id={styles.province} onChange={handleLocation} 
                  value={newdetails.location.province}  required
                >
                  <option value="">province</option>
                  {theProvinces && Object.keys(theProvinces).length >0 && Object.keys(theProvinces).map((province) => (
                    <option key={province} value={province}>{province}</option>
                  ))}
                </select> - 
                <select name="district" id={styles.district} onChange={handleLocation} value={newdetails.location.district}
                  required
                >
                  <option value="">district</option>
                  {locationDistrict && locationDistrict.length>0 &&locationDistrict.map((district) => (
              ...
              <li>
                ...
                name="sector" value={newdetails.location.sector} onChange={handleLocation}  required
                />
              </li>
              </ul>
            </li>
          ...
          <ul className={styles.two}>
            <li>
              <p>Gender:</p>
              <p>
              <select name="gender" id={styles.gender} value={newdetails.gender} onChange={handleChange} required> 
            ...
            <li>
              ...
              <p>
                ...
                name="phone" value={newdetails.contact.phone} onChange={handleContactChange} required
                />
                </p>
            </li>
            <li>
              ...
              <p>
                ...
                name="email" value={newdetails.contact.email} onChange={handleContactChange} required
                />
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                name="age" value={newdetails.age.phone} onChange={handleChange} required
                />
              </p>
            </li>
            <li className={styles.large}>
              <p>Address: </p>
              <p>
                <select name="address_province" id={styles.province} onChange={handleAddress} 
                value={newdetails.address.province} required
                >
                  <option value={""}>province</option>
                ...
                <select name="address_district" id={styles.district} onChange={handleAddress} 
                value={newdetails.address.district} required
                >
                  <option value={""}>district</option>
              ...
              <p>
                ...
                name="sector" value={newdetails.address.sector} onChange={handleAddress} required
                />
                <input placeholder={User_details.address.street} id={styles.street} type="text"
                name="street" value={newdetails.address.street} onChange={handleAddress} required
                />
              </p>
            </li>
          </ul>
